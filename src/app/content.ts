...
export const CHARAKTERISTIKA_GROUPS: Group[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "dataVen",
        label: "Smí firemní data do externích AI služeb?",
        hint: "Většina AI nástrojů běží v cloudu. Jestli data nesmí ven, míříte na nástroje s firemní ochranou dat nebo provoz u vás — užší, ale reálný výběr.",
        options: [
          { v: "ano", t: "Ano, běžně" },
          { v: "podminky", t: "Jen za jasných podmínek" },
          { v: "ne", t: "Ne, musí zůstat u nás" },
          { v: "nevim", t: "Neřešili jsme" },
        ],
      },
      {
        key: "systemy",
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: "dovednosti",
        label: "Jak jsou vaši lidé technicky zdatní?",
        hint: "Ne postoj, ale dovednost. Zdatnost s běžným softwarem rozhoduje, jak rychle si lidé osvojí nové nástroje a kolik školení bude potřeba.",
        options: [
          { v: "vysoka", t: "Zvládnou nový software sami" },
          { v: "stredni", t: "Smíšené dovednosti" },
          { v: "nizka", t: "Se softwarem spíš bojují" },
        ],
      },
      {
        key: "lide",
      ...
      {
        key: "vyvoj",
        label: "Kdo bude AI řešení stavět?",
        hint: "Vlastní vývoj dává kontrolu a nezávislost, ale potřebuje lidi a čas. Dodavatel je rychlejší start, ale riziko závislosti a opakovaných nákladů. Rozhoduje to, koho budete do týmu shánět.",
        options: [
          { v: "vlastni", t: "Vyvíjet vlastními silami" },
          { v: "dodavatel", t: "Dodá třetí strana" },
          { v: "kombinace", t: "Kombinace obojího" },
          { v: "nevim", t: "Zatím nevíme" },
        ],
      },
      {
